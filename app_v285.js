...
function drawFloorplan(preview=null){
  ...
  try{
    ...
    // v2.8.5: Walls are always rendered first. This prevents sanitary/furniture
...
function drawFpObject(o,preview=false){
  ...
  if(o.type==='wall'){
    // v2.8.5: authoritative robust wall pass.
...
/* v2.8.5 – authoritative runtime version stamp */
(()=>{
  const VERSION='2.8.5 PRO';
