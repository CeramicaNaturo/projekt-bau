...
function save(){
  try{
    // v2.8.7: mark the active project for deterministic multi-device cloud sync.
    try{
...
function drawFloorplan(preview=null){
  ...
  try{
    ...
    // v2.8.6: Walls are always rendered first. This prevents sanitary/furniture
...
function drawFpObject(o,preview=false){
  ...
  if(o.type==='wall'){
    // v2.8.6: authoritative robust wall pass.
