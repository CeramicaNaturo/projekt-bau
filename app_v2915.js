...
function fpBeginHeldWallDrag(hit,startPoint){
  ...
  fpWallMoveHold.connected=[]; // v2.9.15 selected wall only
  ...
  if(fpTool==='select' && fpSelectedId){
    ...
    if(o.type==='wall'){
      if(fpEndpointDrag==='start'){
        ...
        // v2.9.15: only the selected wall moves.
...
/* === v2.9.15 Object Properties Editor === */
...
/* === v2.9.15 Visible Objekt-bearbeiten button === */
