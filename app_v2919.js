...
function fpBeginHeldWallDrag(hit,startPoint){
  ...
  fpWallMoveHold.connected=[]; // v2.9.19 selected wall only
...
/* === v2.9.19 ARCHITECTURAL INNER-FACE MEASUREMENT ===
  ...
  if(fpTool==='select' && fpSelectedId){
    ...
    if(o.type==='wall'){
      if(fpEndpointDrag==='start'){
        ...
        // v2.9.19: only the selected wall moves.
...
/* === v2.9.19 Object Properties Editor === */
...
/* === v2.9.19 Visible Objekt-bearbeiten button === */
