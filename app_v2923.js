...
function fpBeginHeldWallDrag(hit,startPoint){
  ...
  fpWallMoveHold.connected=[]; // v2.9.23 selected wall only
...
/* === v2.9.23 ARCHITECTURAL INNER-FACE MEASUREMENT ===
...
/* === v2.9.23 WALL-TO-WALL HARD STOP ===
...
/* v2.9.23: A wall that starts on an existing boundary wall may only grow
...
/* === v2.9.23 ROBUST WALL COLLISION ENGINE ===
  ...
  if(fpTool==='select' && fpSelectedId){
    ...
    if(o.type==='wall'){
      if(fpEndpointDrag==='start'){
        ...
        // v2.9.23: only the selected wall moves.
...
/* === v2.9.23 Object Properties Editor === */
...
/* === v2.9.23 Visible Objekt-bearbeiten button === */
