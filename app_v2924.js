...
function fpBeginHeldWallDrag(hit,startPoint){
  ...
  fpWallMoveHold.connected=[]; // v2.9.24 selected wall only
...
/* === v2.9.24 ARCHITECTURAL INNER-FACE MEASUREMENT ===
...
/* === v2.9.24 WALL-TO-WALL HARD STOP ===
...
/* v2.9.24: A wall that starts on an existing boundary wall may only grow
...
/* === v2.9.24 ROBUST WALL COLLISION ENGINE ===
  ...
  if(fpTool==='select' && fpSelectedId){
    ...
    if(o.type==='wall'){
      if(fpEndpointDrag==='start'){
        ...
        // v2.9.24: only the selected wall moves.
...
/* === v2.9.24 Object Properties Editor === */
...
/* === v2.9.24 Visible Objekt-bearbeiten button === */
