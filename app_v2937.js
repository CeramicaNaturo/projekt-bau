...
/* === v2.9.37 INNER-LENGTH WALL INPUT MODEL ===
...
function fpApplyInnerLengthToWall2936(wall,innerLength,angleDeg){
  ...
  // v2.9.37: one source of truth for thickness.
  wall.thickness=t;
  fpWallThickness=t;
...
function fpBeginHeldWallDrag(hit,startPoint){
  ...
  fpWallMoveHold.connected=[]; // v2.9.37 selected wall only
...
/* === v2.9.37 ARCHITECTURAL INNER-FACE MEASUREMENT ===
...
/* === v2.9.37 ARCHITECTURAL MITER WALL MODEL === */
  ...
  if(fpTool==='select' && fpSelectedId){
    ...
    if(o.type==='wall'){
      if(fpEndpointDrag==='start'){
        ...
        // v2.9.37: only the selected wall moves.
...
function floorEnd(ev){
  ...
  if((fpTool==='wall') && fpStart){
    ...
    // v2.9.37: endpoint intentionally does not magnetize to existing corners.
...
function drawFpObject(o,preview=false){
  ...
  if(o.type==='wall'){
    // v2.9.37 mitered architectural wall polygon.
  ...
  if(o.type==='door'){
    ...
    // v2.9.37: symbol base MUST equal declared default 90 x 90 cm.
...
/* === v2.9.37 Object Properties Editor === */
...
/* === v2.9.37 UNIVERSAL HEIGHT ABOVE FLOOR === */
...
/* === v2.9.37 Visible Objekt-bearbeiten button === */
