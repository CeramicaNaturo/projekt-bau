...
/* === v2.9.39 INNER-LENGTH WALL INPUT MODEL ===
...
function fpApplyInnerLengthToWall2936(wall,innerLength,angleDeg){
  ...
  // v2.9.39: one source of truth for thickness.
  wall.thickness=t;
  fpWallThickness=t;
...
function calculateFloorAreaM2(objects){
  /*
   * v2.9.39 — BODENFLÄCHE = echte lichte Innenfläche
   *
...
function fpBeginHeldWallDrag(hit,startPoint){
  ...
  fpWallMoveHold.connected=[]; // v2.9.39 selected wall only
...
/* === v2.9.39 ARCHITECTURAL INNER-FACE MEASUREMENT ===
...
/* === v2.9.39 ARCHITECTURAL MITER WALL MODEL === */
  ...
  if(fpTool==='select' && fpSelectedId){
    ...
    if(o.type==='wall'){
      if(fpEndpointDrag==='start'){
        ...
        // v2.9.39: only the selected wall moves.
...
function floorEnd(ev){
  ...
  if((fpTool==='wall') && fpStart){
    ...
    // v2.9.39: endpoint intentionally does not magnetize to existing corners.
...
function drawFpObject(o,preview=false){
  ...
  if(o.type==='wall'){
    // v2.9.39 mitered architectural wall polygon.
  ...
  if(o.type==='door'){
    ...
    // v2.9.39: symbol base MUST equal declared default 90 x 90 cm.
...
/* === v2.9.39 Object Properties Editor === */
...
/* === v2.9.39 UNIVERSAL HEIGHT ABOVE FLOOR === */
...
/* === v2.9.39 Visible Objekt-bearbeiten button === */
